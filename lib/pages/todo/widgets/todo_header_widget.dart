        ...
        children: [
          ...
          BlocListener<TodoListBloc, TodoListState>(
            listener: (context, state) {
              final int activeTodoCountData =
                  state.todoList
                      .where((TodoModel todos) => todos.completed == false)
                      .toList()
                      .length;
              context.read<TodoActiveBloc>().add(CalculateActiveTodoCountEvent(activeTodoCount: activeTodoCountData));
            },
            child: BlocBuilder<TodoActiveBloc, TodoActiveState>(
